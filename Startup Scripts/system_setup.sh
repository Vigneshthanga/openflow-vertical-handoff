...
#ovs-vsctl set-fail-mode $IFACE_bridge_eth standalone
...
ovs-vsctl set-fail-mode $IFACE_bridge_wlan0 standalone
...
ovs-vsctl set-fail-mode $IFACE_bridge_wlan1 standalone
...
ovs-vsctl set-fail-mode $IFACE_bridge_wimax standalone
...
ovs-vsctl set-fail-mode $IFACE_bridge_int standalone
...
iwconfig $IFACE_wlan0 essid MyAP ap 00:0C:42:6A:4F:5E channel 11 mode Managed
